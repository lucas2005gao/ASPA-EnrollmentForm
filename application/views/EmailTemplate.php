...
<h1 style="display:block;margin:0;padding:0;color:#888888;font-family:Helvetica;font-size:30px;font-style:normal;font-weight:bold;line-height:100%;letter-spacing:normal;text-align:left"><span style="font-size:38px"><span style="color:#303030">Thank you for siging up to <?php echo $EVENT_NAME;?> </span></span></h1>
...
<p style="text-align:center;margin:10px 0;padding:0;color:<?php echo $MSG_COLOUR;?> ;font-family:Helvetica;font-size:40px;line-height:150%">
<strong>
<?php echo $PAYMENT_DETAIL;?> <br>
